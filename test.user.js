...
(function() {
    ...
    async function handleCapture() {
        ...
        try {
            ...
            // ▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼ 여기가 변경된 부분입니다 ▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼
            //
            // html2canvas 대신 htmlToImage.toCanvas를 사용합니다.
            // toCanvas는 Canvas 엘리먼트를 반환하므로, 기존의 toDataURL 로직을 그대로 사용할 수 있어
            // PNG, JPEG, WEBP 포맷을 모두 지원할 수 있습니다.
            const canvas = await htmlToImage.toCanvas(captureArea, { backgroundColor: bgColor });
            //
            // ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
            // ==========================================================
